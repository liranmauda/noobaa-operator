...
replace (
	...
	// CNPG bumps the deps in controller-runtime and k8s.io. We still need to use v0.33.3 and v0.21.0
	// Pin k8s.io dependencies to v0.33.3 and controller-runtime to v0.21.0
